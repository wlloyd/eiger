...
for trial in $(seq $num_trials); do
    ...
    for cpkwANDkeys in 8:100000 16:10000 32:10000 64:10000 1:1000000 2:100000 4:1000000 5:1000000; do
	cols_per_key_write=$(echo $cpkwANDkeys | awk -F":" '{ print $1 }')
	total_keys=$(echo $cpkwANDkeys | awk -F":" '{ print $2 }')
	variable=$cols_per_key_write

	echo -e "Running $0\t$variable at $(date)" >> ~/cops2/experiments/progress


	if [[ $cols_per_key_write -lt 6 ]]; then
	    total_keys=1000000
	else
	    total_keys=$((1000000 * 5 / $cols_per_key_write))
	fi
