...
if [ "$machine_name" == "wlloyds-macbook-pro.local" ]; then
    ...
    kill_all_cmd="${cops_dir}/vicci_cassandra_killer.bash ${cops_dir}/vicci_dcl_config/32_in_princeton"
...
#debugging, try to find the problem
total_keys=20000
value_size=1
cols_per_key_read=5
cols_per_key_write=5
keys_per_read=5
keys_per_write=5
write_frac=1.0
write_trans_frac=1.0
#num_clients_per_dc=1
trial=1
