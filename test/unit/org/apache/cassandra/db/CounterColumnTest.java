...
public class CounterColumnTest extends SchemaLoader
{
    ...
    {
        long delta = 3L;
        CounterUpdateColumn cuc = new CounterUpdateColumn(ByteBufferUtil.bytes("x"), delta, 1L, null);
    ...
    public void testReconcile() throws UnknownHostException
    {
        ...
        // tombstone + tombstone
        left  = new DeletedColumn(ByteBufferUtil.bytes("x"), 1, 1L, null);
        right = new DeletedColumn(ByteBufferUtil.bytes("x"), 2, 2L, null);
        ...
        // tombstone > live
        left  = new DeletedColumn(ByteBufferUtil.bytes("x"), 1, 2L, null);
        ...
        // tombstone > live last delete
        left  = new DeletedColumn(ByteBufferUtil.bytes("x"), 1, 4L, null);
        ...
        right = new DeletedColumn(ByteBufferUtil.bytes("x"), 1, 2L, null);

        assert left.reconcile(right) == right;

        // live last delete > tombstone
        left  = new CounterColumn(ByteBufferUtil.bytes("x"), 0L, 4L, 2L);
        right = new DeletedColumn(ByteBufferUtil.bytes("x"), 1, 1L, null);
        ...
        right = new DeletedColumn(ByteBufferUtil.bytes("x"), 1, 4L, null);
