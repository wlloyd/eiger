...
public class Message
{
    ...
    final long lamportTimestamp_;
    
    /**
     * This constructor (with a lamport timestamp) should be used when
     * constructing a message that has been received.
     * 
     * @param header
     * @param body
     * @param version
     ...
     */
    public Message(Header header, byte[] body, int version, long lamportTimestamp)
    {
        assert header != null;
        assert body != null;
        ...
        this.lamportTimestamp_ = lamportTimestamp;
    }
    
    /**
     * This constructor (without a specified lamport timestamp) should be used
     * when constructing a message to send.
     * 
     * @param header
     * @param body
     * @param version
    ...
    {
        /* We set the lamport timestamp for the message now, when we have
         * logically sent it.  It is okay the message isn't actually sent
         * yet, we can think of the local queuing and sending code logically
         * as part of the network.
         */
        this(header, body, version, LamportClock.sendTimestamp());
    }
