...
import org.apache.cassandra.db.transaction.TransactionCohortVerbHandler;
import org.apache.cassandra.db.transaction.TransactionCoordinatorVerbHandler;
import org.apache.cassandra.db.transaction.TransactionMessageVerbHandler;
...
public class StorageService implements IEndpointStateChangeSubscriber, StorageServiceMBean
{
    ...
    */
    ...
    /**
     * This methods attempts to return the N endpoints *in this datacenter*
     * that are responsible for storing the specified key
     *
     * @param table
     * @param key
     * @return the endpoints in the *local* datacenter responsible for storing this key
     */
    public List<InetAddress> getLocalLiveNaturalEndpoints(String table, ByteBuffer key)
    {
