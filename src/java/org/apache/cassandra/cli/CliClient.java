...
public class CliClient
{
    ...
    private final Set<Dep> NO_DEPS = new HashSet<Dep>();
            ...
            throws TException, InvalidRequestException, UnavailableException, TimedOutException
    {
        ...
        int count = thriftClient.get_count(getKeyAsBytes(columnFamily, columnFamilySpec.getChild(1)), colParent, predicate, consistencyLevel, LamportClock.COPS_UNSUPPORTED).value;
            ...
            throws TException, InvalidRequestException, UnavailableException, TimedOutException
    {
        ...
        {
            thriftClient.remove_counter(key, path, consistencyLevel, NO_DEPS, LamportClock.COPS_UNSUPPORTED);
        }
        else
        {
            thriftClient.remove(key, path, FBUtilities.timestampMicros(), consistencyLevel, NO_DEPS, LamportClock.COPS_UNSUPPORTED);
        }
            ...
            throws InvalidRequestException, UnavailableException, TimedOutException, TException, IllegalAccessException, NotFoundException, InstantiationException, NoSuchFieldException
    {
        ...
        List<ColumnOrSuperColumn> columns = thriftClient.get_slice(key, parent, predicate, consistencyLevel, LamportClock.COPS_UNSUPPORTED).value;
            ...
            throws TException, NotFoundException, InvalidRequestException, UnavailableException, TimedOutException, IllegalAccessException, InstantiationException, ClassNotFoundException, NoSuchFieldException
    {
        ...
        try
        {
            column = thriftClient.get(key, path, consistencyLevel, LamportClock.COPS_UNSUPPORTED).value.column;
        }
            ...
            throws TException, NotFoundException, InvalidRequestException, UnavailableException, TimedOutException, IllegalAccessException, InstantiationException, ClassNotFoundException, NoSuchFieldException
    {
        ...
        try
        {
            column = thriftClient.get(key, path, consistencyLevel, LamportClock.COPS_UNSUPPORTED).value.counter_column;
        }
        catch (NotFoundException e)
        {
            sessionState.out.println("Value was not found");
    ...
    private void executeGetWithConditions(Tree statement)
    {
        ...
        {
            ColumnParent parent = new ColumnParent(columnFamily);
            slices = thriftClient.get_indexed_slices(parent, clause, predicate, consistencyLevel, LamportClock.COPS_UNSUPPORTED).value;
        ...
        throws TException, InvalidRequestException, UnavailableException, TimedOutException, NoSuchFieldException, InstantiationException, IllegalAccessException
    {
        ...
        // do the insert
        thriftClient.insert(getKeyAsBytes(columnFamily, keyTree), parent, columnToInsert, consistencyLevel, NO_DEPS, LamportClock.COPS_UNSUPPORTED);
            ...
            throws TException, NotFoundException, InvalidRequestException, UnavailableException, TimedOutException, IllegalAccessException, InstantiationException, ClassNotFoundException, NoSuchFieldException
    {
        ...
        // do the insert
        thriftClient.add(key, parent, columnToInsert, consistencyLevel, NO_DEPS, LamportClock.sendTimestamp());
            ...
            throws TException, InvalidRequestException, NotFoundException, IllegalAccessException, InstantiationException, NoSuchFieldException, UnavailableException, TimedOutException, CharacterCodingException
    {
        ...
        List<KeySlice> keySlices = thriftClient.get_range_slices(columnParent, predicate, range, consistencyLevel, LamportClock.COPS_UNSUPPORTED).value;
    ...
    private void executeTruncate(String columnFamily) throws TException, InvalidRequestException, UnavailableException, TimedOutException
    {
        ...
        thriftClient.truncate(cfDef.getName(), NO_DEPS, LamportClock.COPS_UNSUPPORTED);
    ...
    private void executeUseKeySpace(Tree statement) throws TException
    {
        ...
        try
        {
            ...
            thriftClient.set_keyspace(keySpaceName, LamportClock.sendTimestamp());
