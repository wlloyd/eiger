...
public interface IColumn
{
    ...
    public ByteBuffer transactionCoordinatorKey(); // returns the coordinator key if a transaction that wrote this value, or null otherwise

    /** Metadata needed for read transactions */
    ...
    public SortedSet<IColumn> previousVersions();
