...
public class SystemTable
{
    ...
    */
    ...
    {
        long logicalNow = LamportClock.getVersion();
        ...
        cf.addColumn(new Column(newNodeId.bytes(), ip, logicalNow));
        ColumnFamily cf2 = cf.cloneMe();
        if (oldNodeId != null)
        {
            cf2.addColumn(new DeletedColumn(oldNodeId.bytes(), (int) (now / 1000), logicalNow, null));
        }
