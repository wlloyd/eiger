...
public class DatabaseDescriptor
{
   ...
   public static String getClusterName()
    ...
    public static int getGetTransactionTimeoutInMs()
    {
        return conf.get_transaction_timeout_in_ms;
    }

    public static boolean isForcedByTimeReadIndirection()
    {
        return conf.forced_by_time_read_indirection;
    }
}
