...
public final class KSMetaData
{
    ...
    public static KSMetaData testMetadataNotDurable(String name, Class<? extends AbstractReplicationStrategy> strategyClass, Map<String, String> strategyOptions, Iterable<CFMetaData> cfDefs)
    {
        return new KSMetaData(name, strategyClass, strategyOptions, false, cfDefs);
    }
