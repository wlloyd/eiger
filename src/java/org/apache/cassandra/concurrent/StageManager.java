...
public class StageManager
{
    ...
    public static final long KEEPALIVE_FOREVER = Long.MAX_VALUE;

    static
    {
        stages.put(Stage.MUTATION,  multiThreadedStageFixedPoolNoTimeout(Stage.MUTATION, getConcurrentWriters()));
    ...
    private static ThreadPoolExecutor multiThreadedStageFixedPoolNoTimeout(Stage stage, int numThreads)
    {
        return new JMXEnabledThreadPoolExecutor(numThreads,
                                                numThreads,
                                                KEEPALIVE_FOREVER,
