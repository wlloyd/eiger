...
public class GetResult implements org.apache.thrift.TBase<GetResult, GetResult._Fields>, java.io.Serializable, Cloneable {
  ...
  public ColumnOrSuperColumn value; // required
  ...
  public GetResult(GetResult other) {
    ...
    if (other.isSetValue()) {
      this.value = new ColumnOrSuperColumn(other.value);
    }
    this.lts = other.lts;
  }
  ...
  public ColumnOrSuperColumn getValue() {
    return this.value;
  }

  public GetResult setValue(ColumnOrSuperColumn value) {
    this.value = value;
    return this;
  }
  ...
  public GetResult setLts(long lts) {
    this.lts = lts;
    setLtsIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case VALUE:
      if (value == null) {
        ...
        setValue((ColumnOrSuperColumn)value);
      }
      break;
      ...
      switch (field.id) {
        case 1: // VALUE
          if (field.type == org.apache.thrift.protocol.TType.STRUCT) {
            this.value = new ColumnOrSuperColumn();
