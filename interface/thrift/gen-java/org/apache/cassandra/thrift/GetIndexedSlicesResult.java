...
public class GetIndexedSlicesResult implements org.apache.thrift.TBase<GetIndexedSlicesResult, GetIndexedSlicesResult._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetIndexedSlicesResult");
  ...
  public List<KeySlice> value; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetIndexedSlicesResult.class, metaDataMap);
  }

  public GetIndexedSlicesResult() {
  }
   ...
   */
  public GetIndexedSlicesResult(GetIndexedSlicesResult other) {
    __isset_bit_vector.clear();
    __isset_bit_vector.or(other.__isset_bit_vector);
    if (other.isSetValue()) {
      List<KeySlice> __this__value = new ArrayList<KeySlice>();
      for (KeySlice other_element : other.value) {
        __this__value.add(new KeySlice(other_element));
      }
  ...
  public GetIndexedSlicesResult deepCopy() {
    return new GetIndexedSlicesResult(this);
  }
  ...
  public java.util.Iterator<KeySlice> getValueIterator() {
    return (this.value == null) ? null : this.value.iterator();
  }

  public void addToValue(KeySlice elem) {
    if (this.value == null) {
      this.value = new ArrayList<KeySlice>();
    }
    this.value.add(elem);
  }

  public List<KeySlice> getValue() {
    return this.value;
  }

  public GetIndexedSlicesResult setValue(List<KeySlice> value) {
    this.value = value;
    return this;
  }
  ...
  public GetIndexedSlicesResult setLts(long lts) {
    this.lts = lts;
    setLtsIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetIndexedSlicesResult)
      return this.equals((GetIndexedSlicesResult)that);
    return false;
  }

  public boolean equals(GetIndexedSlicesResult that) {
    if (that == null)
      return false;
  ...
  public int compareTo(GetIndexedSlicesResult other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    GetIndexedSlicesResult typedOther = (GetIndexedSlicesResult)other;
          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.value = new ArrayList<KeySlice>(_list122.size);
              for (int _i123 = 0; _i123 < _list122.size; ++_i123)
              {
                KeySlice _elem124; // required
                _elem124 = new KeySlice();
                _elem124.read(iprot);
                this.value.add(_elem124);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    ...
    if (this.value != null) {
      oprot.writeFieldBegin(VALUE_FIELD_DESC);
      {
        ...
        for (KeySlice _iter125 : this.value)
        {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetIndexedSlicesResult(");
    boolean first = true;
