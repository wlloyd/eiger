...
public class GetSliceResult implements org.apache.thrift.TBase<GetSliceResult, GetSliceResult._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetSliceResult");
  ...
  public List<ColumnOrSuperColumn> value; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetSliceResult.class, metaDataMap);
  }
  ...
  public GetSliceResult(
    List<ColumnOrSuperColumn> value,
    long lts)
  {
    this();
    this.value = value;
   ...
   */
  public GetSliceResult(GetSliceResult other) {
    __isset_bit_vector.clear();
    __isset_bit_vector.or(other.__isset_bit_vector);
    if (other.isSetValue()) {
      List<ColumnOrSuperColumn> __this__value = new ArrayList<ColumnOrSuperColumn>();
      for (ColumnOrSuperColumn other_element : other.value) {
        __this__value.add(new ColumnOrSuperColumn(other_element));
      }
  ...
  public GetSliceResult deepCopy() {
    return new GetSliceResult(this);
  }
  ...
  public java.util.Iterator<ColumnOrSuperColumn> getValueIterator() {
    return (this.value == null) ? null : this.value.iterator();
  }

  public void addToValue(ColumnOrSuperColumn elem) {
    if (this.value == null) {
      this.value = new ArrayList<ColumnOrSuperColumn>();
    }
    this.value.add(elem);
  }

  public List<ColumnOrSuperColumn> getValue() {
    return this.value;
  }

  public GetSliceResult setValue(List<ColumnOrSuperColumn> value) {
    this.value = value;
    return this;
  }
  ...
  public GetSliceResult setLts(long lts) {
    this.lts = lts;
    setLtsIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case VALUE:
      if (value == null) {
        ...
        setValue((List<ColumnOrSuperColumn>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetSliceResult)
      return this.equals((GetSliceResult)that);
    return false;
  }

  public boolean equals(GetSliceResult that) {
    if (that == null)
      return false;
  ...
  public int compareTo(GetSliceResult other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    GetSliceResult typedOther = (GetSliceResult)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetSliceResult(");
    boolean first = true;
